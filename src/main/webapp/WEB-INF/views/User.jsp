    ...
    <div class="parallax " style="top: 50%; position: reative;">
        <div class="slideshow-container">
            ...
            rel="stylesheet" href="/resources/css/style.css"
                ...
                <img  src="/resources/images/amit.png" style="height: 400px;margin-left:150px;">
                <div class="text">
            ...
            <div class="mySlides fade">
                <img src="/resources/images/bhanu.png" style="height: 400px;margin-left:150px;">
                <div class="text">
            ...
            <div class="mySlides fade">
                <img src="/resources/images/dipti.png" style="height: 400px;margin-left:150px;">
                <div class="text">
                    <h3 style="margin-left:150px;">Diptimayee Bebarta</h3>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="/resources/images/karthik.png" style="height: 400px;margin-left:150px;">
                <div class="text">
            ...
            <div class="mySlides fade">
                <img src="/resources/images/yasaswi.png" style="height: 400px;margin-left:150px;">
                <div class="text">
                    <h3 style="margin-left:150px;">Madhava Yasawi</h3>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="/resources/images/naitik.png" style="height: 400px;margin-left:150px;">
                <div class="text">
                    <h3 style="margin-left:150px;">Naitik Rana</h3>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="/resources/images/pavan.png" style="height: 400px;margin-left:150px;">
                <div class="text">
                    <h3 style="margin-left:150px;">Pavan S</h3>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="/resources/images/puja.png" style="height: 400px;margin-left:150px;">
                <div class="text">
                    <h3 style="margin-left:150px;">Puja Baidya</h3>
                </div>
            </div>
            <div class="mySlides fade">
                <img src="/resources/images/varinder.png" style="height: 400px;margin-left:150px;">
                <div class="text">
